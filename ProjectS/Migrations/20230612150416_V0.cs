        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeStatus = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => x.PaymentCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportStatus = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__bills__payment_c__38996AB5",
                        column: x => x.PaymentCode,
                        principalTable: "Payments",
                        principalColumn: "PaymentCode");
                    table.ForeignKey(
                        name: "FK__bills__transport__3A81B327",
                        column: x => x.TransportId,
                        principalTable: "Transports",
                        principalColumn: "TransportId");
                    table.ForeignKey(
                        name: "FK__bills__user_id__398D8EEE",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    feedback_title = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    feedback_detail = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    feedback_answer = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    feedback_status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__feedback__produc__403A8C7D",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK__feedback__user_i__276EDEB3",
                        column: x => x.user_id,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
